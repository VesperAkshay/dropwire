...
4. **Automatic Resume:** If your connection drops halfway, don't panic! Just run the exact same `receive` command again. DropWire will automatically detect the `.dwstate` state file and instantly resume the transfer right where it left off.
